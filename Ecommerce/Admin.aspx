...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="50">
    <form id="form1" runat="server">
        <nav class="navbar navbar-default navbar-fixed-top">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="">Sandy's Souvenir</a>
                </div>
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav navbar-right">
                        <li><a><span class="badge"><asp:Label ID="ActiveUsers" runat="server" Text="ADMIN PAGE" ForeColor="Lime"></asp:Label></span></a></li>
                    </ul>
                </div>
            </div>
        </nav>
        ...
        <div id="SingIN" class="bg-1">
            ...
            <p class="text-center">Log in with <a href="SingIn.aspx"><strong>User Account ?</strong></a></p>
                <div class="row">
                    <div class="col-md-3">
